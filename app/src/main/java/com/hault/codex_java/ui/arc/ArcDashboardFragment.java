...
public class ArcDashboardFragment extends Fragment {
    ...
    private void updateUI() {
        ...
        if (currentArcWithDetails.arc.imageUri != null && !currentArcWithDetails.arc.imageUri.isEmpty()) {
            Glide.with(this)
                    .load(Uri.parse(currentArcWithDetails.arc.imageUri))
                    .centerCrop()
                    .into(imageViewHeader);
        }

        if (currentArcWithDetails.arc.colorHex != null && !currentArcWithDetails.arc.colorHex.isEmpty()) {
            int color = Color.parseColor(currentArcWithDetails.arc.colorHex);
