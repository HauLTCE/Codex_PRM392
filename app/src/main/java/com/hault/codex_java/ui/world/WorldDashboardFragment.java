...
public class WorldDashboardFragment extends Fragment {
    ...
    private void updateUI() {
        ...
        if (currentWorldWithDetails.world.imageUri != null && !currentWorldWithDetails.world.imageUri.isEmpty()) {
            Glide.with(this)
                    .load(Uri.parse(currentWorldWithDetails.world.imageUri))
                    .centerCrop()
                    .into(imageViewHeader);
        }

        if (currentWorldWithDetails.world.colorHex != null && !currentWorldWithDetails.world.colorHex.isEmpty()) {
            int color = Color.parseColor(currentWorldWithDetails.world.colorHex);
